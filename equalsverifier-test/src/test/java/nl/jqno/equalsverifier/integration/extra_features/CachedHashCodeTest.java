...
class CachedHashCodeTest {
    ...
    private static final String MALFORMED_CALCULATEHASHCODEMETHOD =
            "Could not find calculateHashCodeMethod: must be 'private int";
    private static final String MALFORMED_CACHEDHASHCODEFIELD =
    ...
    void fail_whenCachedHashCodeIsValid_givenWithCachedHashCodeIsNotUsed() {
        ExpectedException
                ...
                .assertFailure()
                .assertMessageContains("Significant fields", "equals relies on", "name", "but hashCode does not");
    }
                ...
                .when(
                    () -> EqualsVerifier
                            ...
                            .withCachedHashCode(
                                ...
                                new ObjectWithValidCachedHashCode(SOME_NAME)))
                .assertThrows(IllegalArgumentException.class)
                .assertMessageContains(CACHED_HASHCODE, MALFORMED_CALCULATEHASHCODEMETHOD, "doesNotExist");
    }
                ...
                .when(
                    () -> EqualsVerifier
                            ...
                            .withCachedHashCode(
                                ...
                                new InvalidCalculateHashCodeMethodsContainer()))
                .assertThrows(IllegalArgumentException.class)
                .assertMessageContains(CACHED_HASHCODE, MALFORMED_CALCULATEHASHCODEMETHOD, "takesParameters");
    }
    ...
    void succeed_whenCalculateHashCodeMethodAndCalcHashCodeFieldAreProtected() {
        EqualsVerifier
                ...
                .withCachedHashCode(
                    "cachedHashCode",
                    "calcHashCode",
                    new ObjectWithProtectedCalculateHashCodeMembers(SOME_NAME))
                .verify();
    }
    ...
    void succeed_whenCalculateHashCodeMethodAndCalcHashCodeFieldHaveDefaultVisibility() {
        EqualsVerifier
                ...
                .withCachedHashCode(
                    "cachedHashCode",
                    "calcHashCode",
                    new ObjectWithDefaultVisibilityCalculateHashCodeMembers(SOME_NAME))
                .verify();
    }
    ...
    void fail_whenNoExampleForCachedHashCodeIsSuppressedAndExampleIsNotNull() {
        ExpectedException
                ...
                .assertMessageContains(
                    CACHED_HASHCODE,
                    "example must be null if " + Warning.NO_EXAMPLE_FOR_CACHED_HASHCODE + " is suppressed");
    }
    ...
    void succeed_whenCachedHashCodeIsLazilyInitialized_givenItIsValid() {
        EqualsVerifier
                ...
                .withCachedHashCode(
                    "cachedHashCode",
                    "calcHashCode",
                    new ObjectWithLazilyInitializedCachedHashCode(SOME_NAME))
                .verify();
    }
    ...
    void succeed_whenCachedHashCodeIsLazilyInitializedAndCachedHashCodeFieldIsCalledInEquals_givenItIsValid() {
        EqualsVerifier
                ...
                .withCachedHashCode(
                    "cachedHashCode",
                    "calcHashCode",
                    new ObjectWithLazyCachedHashCodeAndFieldIsCalledInEquals(SOME_NAME))
                .verify();
    }
    ...
    void succeed_whenCachedHashCodeIsLazilyInitializedAndHashCodeMethodIsCalledInEquals_givenItIsValid() {
        EqualsVerifier
                ...
                .withCachedHashCode(
                    "cachedHashCode",
                    "calcHashCode",
                    new ObjectWithLazyCachedHashCodeAndMethodIsCalledInEquals(SOME_NAME))
                .verify();
    }
    ...
    static class InvalidCalculateHashCodeMethodsContainer {
        ...
        private int takesParameters(int x) {
            return x;
        }
    }
