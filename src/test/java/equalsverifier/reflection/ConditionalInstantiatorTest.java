...
public class ConditionalInstantiatorTest {
    ...
    public void nullIsReturned_whenInvalidConstructorParametersAreProvided_givenFalse() {
        ci = new ConditionalInstantiator("java.utils.GregorianCalendar", false);
    ...
    public void nullIsReturned_whenExternalFactoryIsCalled_givenTypeDoesNotExist() {
        ci = new ConditionalInstantiator(THIS_TYPE_DOES_NOT_EXIST);
        Object actual = ci.callFactory("java.utils.Collections", "emptyList", classes(), objects());
        assertThat(actual, is(nullValue()));
    }
    ...
    public void nullIsReturned_whenExternalFactoryIsCalled_givenFactoryTypeDoesNotExist_givenFalse() {
        ci = new ConditionalInstantiator("java.utils.List", false);

        Object actual = ci.callFactory("java.utils.ThisTypeDoesNotExist", "emptyList", classes(), objects());
        assertThat(actual, is(nullValue()));
    }
    ...
    public void nullIsReturned_whenInvalidExternalFactoryMethodNameIsProvided_givenFalse() {
        ...
        Object actual = ci.callFactory("java.utils.Collections", "thisMethodDoesntExist", classes(), objects());
        assertThat(actual, is(nullValue()));
    }
    ...
    public void nullIsReturned_whenInvalidExternalFactoryMethodParametersAreProvided_givenFalse() {
        ...
        Object actual = ci.callFactory("java.utils.Collections", "emptyList", classes(int.class), objects(42));
        assertThat(actual, is(nullValue()));
    }
