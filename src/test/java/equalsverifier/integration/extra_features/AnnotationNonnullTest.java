...
import equalsverifier.integration.extra_features.nonnull.findbugs1x.javax.NonnullFindbugs1xJavaxOnPackage;
import equalsverifier.integration.extra_features.nonnull.findbugs1x.javax.NonnullFindbugs1xWithNullableOnPackage;
import equalsverifier.integration.extra_features.nonnull.jsr305.custom.NonnullJsr305CustomOnPackage;
import equalsverifier.integration.extra_features.nonnull.jsr305.custom.NonnullJsr305WithNullableOnPackage;
import equalsverifier.integration.extra_features.nonnull.jsr305.inapplicable.NonnullJsr305InapplicableOnPackage;
import equalsverifier.integration.extra_features.nonnull.jsr305.javax.NonnullJsr305JavaxOnPackage;
import equalsverifier.integration.extra_features.nonnull.jsr305.javax.NonnullJsr305WithCheckForNullOnPackage;
import equalsverifier.testhelpers.ExpectedExceptionTestBase;
import equalsverifier.testhelpers.annotations.*;
...
public class AnnotationNonnullTest extends ExpectedExceptionTestBase {
    ...
    public void succeed_whenEqualsDoesntCheckForNull_givenFindbugs1xDefaultAnnotationOnOuterClass() {
        EqualsVerifier.forClass(NonnullFindbugs1xOuter.FInner.class)
                .verify();
    }

    @Test
    public void succeed_whenEqualsDoesntCheckForNull_givenFindbugs1xDefaultAnnotationOnNestedOuterClass() {
        EqualsVerifier.forClass(NonnullFindbugs1xOuter.FMiddle.FInnerInner.class)
                .verify();
    }
    ...
    public void succeed_whenEqualsDoesntCheckForNull_givenJsr305DefaultAnnotationOnOuterClass() {
        EqualsVerifier.forClass(NonnullJsr305Outer.JInner.class)
                .verify();
    }

    @Test
    public void succeed_whenEqualsDoesntCheckForNull_givenJsr305DefaultAnnotationOnNestedOuterClass() {
        EqualsVerifier.forClass(NonnullJsr305Outer.JMiddle.JInnerInner.class)
                .verify();
    }
    ...
    static class NonnullJsr305Outer {
        static final class JInner {
            ...
            public JInner(Object o) { this.o = o; }
        ...
        static class JMiddle {
            static final class JInnerInner {
                ...
                public JInnerInner(Object o) { this.o = o; }
