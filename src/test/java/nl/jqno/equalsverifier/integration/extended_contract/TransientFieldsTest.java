...
public class TransientFieldsTest extends ExpectedExceptionTestBase {
    ...
    @Test
    public void
            succeed_whenFieldsWithTransientModifierAreUsedInEquals_givenWarningsAreSuppressed() {
    ...
    @Test
    public void
            succeed_whenFieldsWithTransientAnnotationAreUsedInEquals_givenWarningsAreSuppressed() {
    ...
    static class NotUsingFieldsWithNonJpaTransientAnnotation {
        private final int i;
        @nl.jqno.equalsverifier.testhelpers.annotations.Transient private final int j;
