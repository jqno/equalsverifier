...
public class CachedHashCodeTest extends ExpectedExceptionTestBase {
    ...
    @Test
    public void
            succeed_whenCachedHashCodeIsValidAndLocatedInSuperclass_givenWithCachedHashCodeIsUsed() {
    ...
    @Test
    public void
            succeed_whenCachedHashCodeFieldIsNotInitialized_givenExampleIsNullAndNoExampleForCachedHashCodeIsSuppressed() {
        EqualsVerifier.forClass(ObjectWithUninitializedCachedHashCode.class)
                .withCachedHashCode("cachedHashCode", "calcHashCode", null)
    ...
    @Test
    public void
            succeed_whenCachedHashCodeIsLazilyInitializedAndHashCodeMethodIsCalledInEquals_givenItIsValid() {
