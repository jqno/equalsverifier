...
public class TypeTagRecursionException extends InternalException {
    private final LinkedHashSet<TypeTag> typeStack;

    /**
     * Constructor.
     *
     * @param typeStack A collection of typetags that have been encountered
     *          prior to detecting the recursion.
     */
    public TypeTagRecursionException(LinkedHashSet<TypeTag> typeStack) {
        super();
