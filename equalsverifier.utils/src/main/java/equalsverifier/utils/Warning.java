...
public enum Warning {
     ...
     * EqualsVerifier would fail in this case.
     * <p>
     * If this warning is suppressed, and it turns out that an instance of the
     * class under test is equal to an identical copy of itself after all,
     * EqualsVerifier will NOT fail.
     */
     ...
     * <p>
     * EqualsVerifier's standard behaviour is to disallow non-final
     ...
     * to prevent EqualsVerifier from checking for non-final fields.
     */
    NONFINAL_FIELDS,
     ...
     * <p>
     * EqualsVerifier's standard behaviour, if T is not final and
     ...
     * <p>
     * EqualsVerifier's standard behaviour is to disallow transient
     * fields being used in {@code equals} and {@code hashCode} methods, since
     ...
     * suppressed to disable EqualsVerifier's transience test.
     */
    TRANSIENT_FIELDS
}
