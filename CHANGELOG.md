...
- If first permitted and non-abstract subclass of a sealed type has a recursion, EqualsVerifier throws RecursionException instead of trying the second permitted non-abstract subclass. ([Issue 1081](https://github.com/jqno/equalsverifier/issues/1081))

### Changed

- Avoids potential parameter order bug when instantiating records. ([Issue 1160](https://github.com/jqno/equalsverifier/issues/1160); thanks lycoris106!)
...
- Kotlin lazy delegates with a generic type throw `ClassCastException`. ([Issue 1132](https://github.com/jqno/equalsverifier/issues/1132))
...
[unreleased]: https://github.com/jqno/equalsverifier/compare/equalsverifier-4.5...HEAD
