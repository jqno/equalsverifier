...
class WithGenericPrefabValuesTest {
    ...
    void fail_whenRegularPrefabValuesOfWrongTypeAreUsed_given1GenericParameter() {
        ExpectedException
                ...
                .assertMessageContains("Generics", "for " + SingleGenericContainer.class.getSimpleName());
    }
    ...
    void fail_whenRegularPrefabValuesOfWrongTypeAreUsed_given2GenericParameters() {
        ExpectedException
                ...
                .assertFailure()
                .assertCause(ClassCastException.class)
                .assertMessageContains("Generics", "for " + DoubleGenericContainer.class.getSimpleName());
    }
