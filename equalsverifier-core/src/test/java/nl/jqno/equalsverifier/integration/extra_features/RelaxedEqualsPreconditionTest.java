...
class RelaxedEqualsPreconditionTest {
    ...
    void fail_whenTheSameExampleIsGivenTwice() {
        ExpectedException
                ...
                .assertFailure()
                .assertMessageContains(PRECONDITION, OBJECT_APPEARS_TWICE, Multiple.class.getSimpleName());
    }
    ...
    void fail_whenTwoExamplesAreIdentical() {
        ...
        ExpectedException
                ...
                .assertFailure()
                .assertMessageContains(PRECONDITION, TWO_IDENTICAL_OBJECTS_APPEAR, Multiple.class.getSimpleName());
    }
    ...
    void fail_whenTwoExamplesAreNotEqualAtAll() {
        ...
        ExpectedException
                .when(() -> EqualsVerifier.forRelaxedEqualExamples(red, aa).andUnequalExample(green).verify())
                .assertFailure()
                .assertMessageContains(PRECONDITION, NOT_ALL_EQUAL_OBJECT_ARE_EQUAL, Multiple.class.getSimpleName());
    }
