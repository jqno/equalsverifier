 ...
 *
 * <p>
 * For each generic type parameter for {@code T}, a value of that type will be supplied in the {@link List} parameter of
...
public interface Func<T> {
    ...
    /**
     * Functional interface for generating prefab values of a generic type {@code T} that has exactly 1 generic
     * parameter {@code A}.
     *
     * <p>
    ...
    /**
     * Functional interface for generating prefab values of a generic type {@code T} that has exactly 2 generic
